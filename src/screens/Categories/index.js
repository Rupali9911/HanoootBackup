...
const Category = () => {
        ...
        return (
            ...
            <TouchableOpacity style={styles.SubCategoryItemsContainer} onPress={() =>
                props.section == 2 && props.item
                    ...
                    // setSubSubCategoryName(props?.name)
    ...
    console.log('subsubsussussusbsb: ', subSubCategory)
    ...
    console.log('Object.keys(subCategoryList): ', subCatgListLoading, subCategoryList, Object.keys(subCategoryList).length)
                        ...
                        Object.keys(subCategoryList).length > 0 ?
                            ...
                            >
                                ...
                                <ListView
                                    ...
                                    scrollEnabled={false}
                                    renderItem={({ item, index }) => {
                                        console.log('here is render items : ', item)
                                        return (
                                            index != 5 ?
                                                <SubCategoryListItems
                                ...
                                {/* <View style={{ flexDirection: 'column', width: '100%', backgroundColor: 'red' }}> */}
                                <ListView
                                    data={subCategoryList?.subcategoryList?.children}
                                    // numColumns={3}
                                    nestedScrollEnabled={false}
                                                ...
                                                <View key={index} >
                                                    ...
                                                    return (
                                                        index != 5 && index < 5 ?
                                                            ...
                                                            index > 5 ? null :
                                                                <ViewMoreButton
                                                                    navigation={subSubCategory?.data}
                                ...
                                />
                                {/* </View> */}
                                {/* {subSubCategory?.data?.length > 0 ?
                                    <SubCategoriesTitle title={subSubCategory?.name} /> : null}
                                <ListView
                                    ...
                                    scrollEnabled={false}
                                    renderItem={({ item, index }) => {
                                        console.log('here is subSubCategory items : ', item, index, index != 5 ? 'true' : 'false')
                                        return (
                                ...
                                /> */}
                                {/* {
                                    subCategoryList?.brandList?.map((brandItem, brandIdx) => {
                                        return (
                                            <View key={brandIdx} >
                                                {getBrandList(brandItem, _i)}
                                            </View>
                                        );
                                    })
                                } */}
